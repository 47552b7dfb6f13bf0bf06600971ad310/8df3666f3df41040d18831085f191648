<template>
  <UiContent title="History Egg" sub="Lịch sử đập trứng của người chơi" no-dot>
    <UiFlex class="gap-1">
...
const getList = async () => {
  try {
    ...
    const data = await useAPI('game/private/manage/egg/history', JSON.parse(JSON.stringify(page.value)))
