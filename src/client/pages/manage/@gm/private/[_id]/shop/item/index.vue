<template>
  <UiContent title="Shop Item" sub="Quản lý vật phẩm bày bán" no-dot>
    <UiFlex class="mb-4 gap-1">
      ...
      <UButton color="yellow" @click="modal.add = true" class="ml-auto">Thêm mới</UButton>
      <UButton color="gray" icon="i-bx-time" :to="`/manage/@gm/private/${game._id}/shop/item/history`">Lịch sử</UButton>
    </UiFlex>
