<template>
  <UiContent title="Withdraw" sub="Lịch sử rút tiền">
    <UiFlex class="mb-4 gap-1">
      ...
      <UButton color="yellow" class="ml-auto" @click="openCreate">Tạo lệnh</UButton>
    </UiFlex>
    ...
    <UModal v-model="modal.create" preventClose>
      <UForm :state="stateCreate" @submit="createAction" class="bg-card rounded-2xl p-4">
        ...
        <UiFlex justify="end" class="mt-4">
          <UButton type="submit" :loading="loading.create">Tạo Lệnh</UButton>
