...
const actions = (row) => [
  [{
    ...
    click: () => {
      ...
      stateSuccess.value.collab = route.params._code
...
const getList = async () => {
  try {
    ...
    const data = await useAPI('collab/manage/code/payment/list', JSON.parse(JSON.stringify(page.value)))
...
const successAction = async () => {
  try {
    ...
    await useAPI('collab/manage/code/payment/verify', JSON.parse(JSON.stringify(stateSuccess.value)))
...
const refuseAction = async () => {
  try {
    ...
    await useAPI('collab/manage/code/payment/verify', JSON.parse(JSON.stringify(stateRefuse.value)))
