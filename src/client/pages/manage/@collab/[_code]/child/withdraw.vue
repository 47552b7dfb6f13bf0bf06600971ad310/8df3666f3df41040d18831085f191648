<template>
  <UiContent title="Branch Collab - Withdraw" sub="Danh sách lệnh rút tiền của các Cộng Tác Viên nhánh">
...
const actions = (row) => [
  [{
    ...
    click: () => {
      ...
      stateSuccess.value.parent = route.params._code
    ...
    click: () => {
      ...
      stateRefuse.value.parent = route.params._code
