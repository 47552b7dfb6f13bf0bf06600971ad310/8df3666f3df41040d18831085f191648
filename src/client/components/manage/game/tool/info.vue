  ...
  <div class="@container grid grid-cols-12 gap-4">
    ...
    <UiFlex type="col" items="start" class="@3xl:col-span-6 col-span-12">
      <UiFlex justify="between" items="start" class="gap-2 w-full">
        ...
        <ManageGameToolAction :game="game" @update="emits('update')" />
      </UiFlex>
      ...
      <div class="grid grid-cols-12 gap-2 w-full grow">
        ...
        <UiFlex type="col" class="col-span-4 bg-gray-1000 rounded-2xl p-2" justify="center">
          <UiText size="sm" weight="semibold" align="center" class="mb-1">{{ toMoney(game.price.recharge) }}</UiText>
          <UiText color="gray" size="xs" align="center">Tool nạp</UiText>
        </UiFlex>

        <UiFlex type="col" class="col-span-4 bg-gray-1000 rounded-2xl p-2" justify="center">
          <UiText size="sm" weight="semibold" align="center" class="mb-1">{{ toMoney(game.price.mail) }}</UiText>
          <UiText color="gray" size="xs" align="center">Tool thư</UiText>
        </UiFlex>

        <UiFlex type="col" class="col-span-4 bg-gray-1000 rounded-2xl p-2" justify="center">
          <UiText size="sm" weight="semibold" align="center" class="mb-1">- {{ game.discount.vip.month }}%</UiText>
          <UiText color="gray" size="xs" align="center">VIP tháng</UiText>
        </UiFlex>

        <UiFlex type="col" class="col-span-4 bg-gray-1000 rounded-2xl p-2" justify="center">
          <UiText size="sm" weight="semibold" align="center" class="mb-1">- {{ game.discount.vip.forever }}%</UiText>
