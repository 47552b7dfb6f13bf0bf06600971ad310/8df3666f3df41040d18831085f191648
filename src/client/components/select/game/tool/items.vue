<template>
  <UCard class="bg-gray" :ui="{ 
    ...
    <UiFlex justify="end" class="bg-gray-1000 p-2 rounded-t-2xl">
      <UButton color="gray" icon="i-bx-plus" class="color-blue-light bg-anim-light" @click="modal.add = true">Thêm vật phẩm vào danh sách</UButton>
    </UiFlex>
    ...
    <UModal v-model="modal.add" preventClose>
      <UForm @submit="addAction" class="bg-card rounded-2xl p-4">
        ...
        <UiFlex justify="end" class="mt-4">
          <UButton type="submit" color="yellow" size="md">Thêm</UButton>
          <UButton color="gray" size="md" @click="modal.add = false" class="ml-1">Đóng</UButton>
        </UiFlex>
      </UForm>
    </UModal>
    ...
    <UModal v-model="modal.edit" preventClose>
      <UForm @submit="editAction" class="bg-card rounded-2xl p-4">
        ...
        <UiFlex justify="end" class="mt-4">
          <UButton type="submit" color="yellow" size="md">Sửa</UButton>
          <UButton color="gray" size="md" @click="modal.edit = false" class="ml-1">Đóng</UButton>
        </UiFlex>
      </UForm>
    </UModal>
  </UCard>
