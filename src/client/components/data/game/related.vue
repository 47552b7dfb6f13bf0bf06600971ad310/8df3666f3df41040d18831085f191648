<template>
  <UCard :ui="{ body: { padding: 'px-4 sm:px-4 pb-1 sm:pb-1 pt-4 sm:pt-4' }}">
    <UiContent title="Đề Xuất" sub="Các trò chơi liên quan" class="GameRelated" icon="i-entypo-game-controller">
      <DataEmpty text="Không có trò chơi nào cùng thể loại" class="min-h-[250px]" :loading="loading" v-if="!!loading || list.length == 0" />
