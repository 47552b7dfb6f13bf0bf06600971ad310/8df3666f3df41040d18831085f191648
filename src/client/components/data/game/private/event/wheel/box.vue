<template>
  <div class="Wheel border-b-4 border-primary px-4 py-8">
    ...
    >
      ...
      >
        <DataGamePrivateItem class="mx-auto" :item="wheel.item" :amount="wheel.amount" :game="game.code" size="80"  />
      </div>
    </div>
...
const getGiftDeg = () => {
  if(!props.gift) return null
  const indexGift = list.value.findIndex(i => i._id == props.gift._id)
