...
export const DBVoucher = (mongoose : Mongoose) => {
  ...
  const autoCreate = async () => {
    ...
    await model.create({ type: 'PAYMENT', title: 'Phiếu khuyến mãi nạp 5%', value: 5 })
    await model.create({ type: 'PAYMENT', title: 'Phiếu khuyến mãi nạp 10%', value: 10 })
    await model.create({ type: 'PAYMENT', title: 'Phiếu khuyến mãi nạp 15%', value: 15 })
    await model.create({ type: 'PAYMENT', title: 'Phiếu khuyến mãi nạp 20%', value: 20 })
    await model.create({ type: 'PAYMENT', title: 'Phiếu khuyến mãi nạp 25%', value: 25 })
    await model.create({ type: 'PAYMENT', title: 'Phiếu khuyến mãi nạp 30%', value: 30 })
    await model.create({ type: 'PAYMENT', title: 'Phiếu khuyến mãi nạp 35%', value: 35 })
    await model.create({ type: 'PAYMENT', title: 'Phiếu khuyến mãi nạp 40%', value: 40 })
    await model.create({ type: 'PAYMENT', title: 'Phiếu khuyến mãi nạp 45%', value: 45 })
    await model.create({ type: 'PAYMENT', title: 'Phiếu khuyến mãi nạp 50%', value: 50 })
    await model.create({ type: 'PAYMENT', title: 'Phiếu khuyến mãi nạp 55%', value: 55 })
    await model.create({ type: 'PAYMENT', title: 'Phiếu khuyến mãi nạp 60%', value: 60 })
    await model.create({ type: 'PAYMENT', title: 'Phiếu khuyến mãi nạp 65%', value: 65 })
    await model.create({ type: 'PAYMENT', title: 'Phiếu khuyến mãi nạp 70%', value: 70 })
    await model.create({ type: 'PAYMENT', title: 'Phiếu khuyến mãi nạp 75%', value: 75 })
    await model.create({ type: 'PAYMENT', title: 'Phiếu khuyến mãi nạp 80%', value: 80 })
    await model.create({ type: 'PAYMENT', title: 'Phiếu khuyến mãi nạp 85%', value: 85 })
    await model.create({ type: 'PAYMENT', title: 'Phiếu khuyến mãi nạp 90%', value: 90 })
    await model.create({ type: 'PAYMENT', title: 'Phiếu khuyến mãi nạp 100%', value: 100 })
  }
